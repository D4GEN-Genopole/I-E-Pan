...
def cmdLine():
    ...
    parser = argparse.ArgumentParser(
        description="HDF5 2 JSON",
        formatter_class=argparse.RawTextHelpFormatter)
    parser.add_argument('-v', '--version', action='version',
                        version='%(prog)s ' + pkg_resources.get_distribution("HDF5 2 JSON").version)
    ...
    subs = [ppanggolin.formats.writeFlat.writeFlatSubparser(subparsers)]  # subparsers
